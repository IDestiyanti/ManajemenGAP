  ...
  <script src="<?php echo base_url('themes/js/jquery-ui-1.10.4.min.js'); ?>"></script>
  <script src="<?php echo base_url('themes/js/jquery-1.8.3.min.js'); ?>"></script>
  <script type="text/javascript" src="<?php echo base_url('themes/js/jquery-ui-1.9.2.custom.min.js'); ?>"></script>
  <!-- bootstrap -->
  ...
  <<script src="<?php echo base_url('themes/js/fullcalendar.min.js'); ?>"></script>
    ...
    <script src="<?php echo base_url('themes/assets/fullcalendar/fullcalendar/fullcalendar.js'); ?>"></script>
    <!--script for this page only-->
    <script src="<?php echo base_url('themes/js/calendar-custom.js'); ?>"></script>
    <script src="<?php echo base_url('themes/js/jquery.rateit.min.js'); ?>"></script>
    <!-- custom select -->
    <script src="<?php echo base_url('themes/js/jquery.customSelect.min.js'); ?>"></script>
    <script src="<?php echo base_url('themes/assets/chart-master/Chart.js'); ?>"></script>
    ...
    <script src="<?php echo base_url('themes/js/jquery-jvectormap-1.2.2.min.js'); ?>"></script>
    <script src="<?php echo base_url('themes/js/jquery-jvectormap-world-mill-en.js'); ?>"></script>
    <script src="<?php echo base_url('themes/js/xcharts.min.js'); ?>"></script>
    <script src="<?php echo base_url('themes/js/jquery.autosize.min.js'); ?>"></script>
    <script src="<?php echo base_url('themes/js/jquery.placeholder.min.js'); ?>"></script>
    <script src="<?php echo base_url('themes/js/gdp-data.js'); ?>"></script>
    <script src="<?php echo base_url('themes/js/morris.min.js'); ?>"></script>
    <script src="<?php echo base_url('themes/js/sparklines.js'); ?>"></script>
    <script src="<?php echo base_url('themes/js/charts.js'); ?>"></script>
